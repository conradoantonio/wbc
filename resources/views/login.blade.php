                        ...
                        <div class="row align-items-center m-h-100">
                            <div class="mx-auto col-md-8">
                                <div class="p-b-20 text-center">
                                    <p>
                                        <img src="{{ asset('img/logo_completo.png') }}" width="200" alt="">
                                    </p>
                                ...
                                <form class="needs-validation" action="{{url('login')}}" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group floating-label col-md-12">
                                            <label>Correo</label>
                                            <input type="email" required class="form-control" value="{{ request()->session()->pull('email') }}" name="email" placeholder="Correo">
                                        </div>
                                        <div class="form-group floating-label col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-dark btn-block btn-lg">Ingresar</button>
                                </form>
